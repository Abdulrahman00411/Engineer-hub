      ...
      <div
        ...
        <div
          ...
          <div className="modal-body" style={{ padding: "2rem" }}>
            ...
            <p style={{ fontSize: 14, marginBottom: "1.5rem" }}>
              You must login first to place a bid
            </p>
            <button
      ...
      <div
        ...
        <div
          ...
          <div className="modal-body" style={{ padding: "2rem" }}>
            ...
            <p style={{ fontSize: 14 }}>
              Only freelancer / engineer accounts can submit bids.
            </p>
        ...
        <div className="modal-body">
          {submitted ? (
            <div style={{ textAlign: "center", padding: "2rem 0" }}>
              ...
              <h3 style={{ color: "var(--green)", marginTop: 12 }}>
                Bid Submitted!
              </h3>
            ...
            <>
              ...
              <div
                ...
                <div className="alert alert-warn" style={{ fontSize: 12 }}>
                  A strong cover letter and competitive bid rate increase your
                  chances significantly.
                </div>
                <button
                  className="btn btn-primary btn-full"
                  onClick={handleSubmit}
                  disabled={!form.amount || !form.cover}>
                  Submit Bid
                </button>
              </div>
            </>
...
export function HomePage() {
  ...
  const handleCatLeave = () => {
    hoverTimer.current = setTimeout(() => setHoveredCat(false), 220);
  };
      ...
      <section
        ...
        <div
          style={{
            ...
            height: "100%",
            background:
              "linear-gradient(to bottom, transparent, rgba(240,165,0,0.15), transparent)",
            pointerEvents: "none",
          }}></div>
        <div
          className="wrap"
          ...
          <div className="sec-label" style={{ justifyContent: "center" }}>
            Pakistan's #1 Engineering Marketplace
          </div>
          <h1 style={{ marginBottom: "1rem" }}>
            ...
            <span
              style={{
                background:
                  "linear-gradient(135deg, var(--accent) 0%, #FFB800 100%)",
          ...
          <p
            ...
            Find verified software engineers — post projects, order gigs, and
          ...
          <div
            ...
            <button className="btn btn-outline" onClick={() => setPage("gigs")}>
              {" "}
              Browse Gigs
            </button>
          </div>
      ...
      <section
        ...
        <div className="wrap">
          <div
            ...
            <div>
              <div className="sec-label">Top Talent</div>
      ...
      <section
        ...
        <div className="wrap">
          <div
            ...
            <div>
              <div className="sec-label">Latest Opportunities</div>
              <h2>Open Jobs</h2>
            </div>
            <button
              className="btn btn-outline btn-sm"
      ...
      <section
        ...
        <div className="wrap">
          ...
          <div
            ...
            {[
              ...
              <div
                ...
                onMouseLeave={(e) =>
                  (e.currentTarget.style.background = "var(--steel-mid)")
                }>
                <div
                  style={{
                    fontFamily: "var(--font-m)",
          ...
          <div style={{ textAlign: "center", marginTop: "2.5rem" }}>
            <button
              className="btn btn-primary"
              onClick={() => (!user ? openModal("auth") : setPage("jobs"))}>
    ...
    <div
      ...
      <div
        ...
        <div
          className="av av-md"
          style={{
            background: eng.avatar?.bg,
            color: eng.avatar?.color,
            borderColor: (eng.avatar?.color || "var(--accent)") + "44",
            fontSize: 14,
            fontWeight: 700,
          }}>
          {eng.avatar?.initials}
      ...
      <p
        ...
        {eng.bio?.slice(0, 100) || "No bio yet."}
        {eng.bio?.length > 100 ? "..." : ""}
      </p>
      <div
        style={{
      ...
      <div
        ...
        {(eng.skills?.length || 0) > 3 && (
          <span className="tag">+{(eng.skills?.length || 0) - 3}</span>
        )}
      </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
          <div
            style={{
              ...
              height: 7,
              borderRadius: "50%",
              background: eng.available ? "var(--green)" : "var(--text-3)",
            }}></div>
          <span
            style={{
              fontFamily: "var(--font-m)",
              fontSize: 10,
              color: eng.available ? "#4ADE80" : "var(--text-3)",
            }}>
      ...
      <div
        ...
        <div style={{ flex: 1 }}>
          <div
            ...
            <span
              className={`badge badge-${catColors[job.category] || "blue"}`}>
              {job.category}
            </span>
            <span
              className={`badge badge-${job.type === "Fixed Price" ? "blue" : "teal"}`}>
              {job.type}
            </span>
    ...
    <div style={{ padding: "2rem 0" }}>
      <div className="wrap">
            ...
            {CATS.map((c) => (
              <button
                ...
                style={{
                  ...
                  transition: "all 0.15s",
                  background:
                    cat === c ? "var(--accent)" : "var(--steel-light)",
        ...
        {filtered.length > 0 ? (
          <div className="g3">
            {filtered.map((e) => (
              <EngineerCard key={e.id} eng={e} onClick={() => setSelected(e)} />
            ))}
          </div>
        ) : (
          <div
    ...
    <div style={{ padding: "2rem 0" }}>
      ...
      <div className="wrap">
        <div
          ...
          <div>
            <div className="sec-label">Job Board</div>
            <h2>Browse Jobs</h2>
          </div>
          {user?.role === "client" && (
            <button
                ...
                {["All", "Fixed Price", "Hourly"].map((t) => (
                  <button
                    ...
                    style={{
                      ...
                      transition: "all 0.15s",
                      background:
                        type === t ? "var(--accent)" : "var(--steel-light)",
    ...
    <div
      ...
      <div
        ...
        <div style={{ position: "absolute", top: 8, right: 8 }}>
          <span className="badge badge-amber">{gig.category}</span>
        </div>
      </div>
      <div className="card-pad">
        <div
          ...
          <div
            className="av av-sm"
            style={{
              background: gig.avatar?.bg,
              color: gig.avatar?.color,
              fontSize: 10,
              fontWeight: 700,
            }}>
            {gig.initials}
          ...
          <span className="stars" style={{ marginLeft: "auto", fontSize: 11 }}>
            ★ {gig.rating}
          </span>
        ...
        <div className="modal-bg" onClick={() => setOrderGig(null)}>
          <div
            ...
            <div className="modal-hd">
              ...
              <button className="modal-close" onClick={() => setOrderGig(null)}>
                ✕
              </button>
            </div>
            <div className="modal-body">
                ...
                {(orderGig.packages || []).map((pkg, i) => (
                  <div
                    ...
                    <button
                      ...
                      onClick={() => handleOrderGig(orderGig, i)}>
                      Order for ${pkg.price}
                    </button>
                  </div>
                ))}
              ...
              <div className="alert alert-warn" style={{ fontSize: 12 }}>
                💡 Payment is held in escrow and released only after you approve
                the delivered work.
              </div>
            </div>
          </div>
